...
export async function preferCachedRecordImages(_ownerId: DemoOwnerId, records: DemoRecord[], _signal?: AbortSignal): Promise<DemoRecord[]> { return records; }
export async function cacheRecordImage(_ownerId: DemoOwnerId, record: DemoRecord, _signal?: AbortSignal, _savedImageUri?: string): Promise<DemoRecord> { return record; }
