...
export function CompareScreen({ locale, images, draft, active_tab, busy, blocking_reason, onBack, onChangeTab, onOpenOriginal, onConfirmChange, onContinue, onRequestReplacePhoto }: CompareScreenProps) {
