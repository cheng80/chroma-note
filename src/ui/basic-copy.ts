...
export const basicCopy = {
  ko: {
    ...
    settings: '설정', language: '언어', system: '기기 설정', korean: '한국어', english: 'English', model: '컬러 스케치 준비 상태', ready: '준비됨', modelUnprepared: '준비 전', modelLoading: '준비 중', modelFailed: '준비 필요', logout: '로그아웃', deleteAccount: '계정 삭제', unsaved: '이 기기의 미저장 작업은 로그아웃하면 지워져요.', deleteWarning: '계정을 삭제하지 못했어요. 다시 시도해 주세요.', deleting: '삭제 중…', deleteRetry: '삭제 다시 시도',
  },
  en: {
