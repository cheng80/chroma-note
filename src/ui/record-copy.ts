...
export const recordCopy = {
  ko: {
    back: '뒤로가기', close: '닫기', cancel: '이번 편집 취소', apply: '초안에 적용', applyEdit: '수정 내용 적용',
    ...
    datePlaceTitle: '날짜와 장소', analysisTitle: '문구 편집', memoCount: '{count} / 2,000자', dateField: '기록 날짜', placeField: '장소명, 선택 사항', placeHint: '직접 쓰는 이름이에요. 위치정보는 쓰지 않아요.', aiSketchWritingHint: '새 AI 문구는 저장된 컬러 스케치를 바탕으로 만들어요. 실제 사진과 다를 수 있으니 확인하고 고쳐 주세요.', aiWritingHint: 'AI 글과 태그는 사진을 바탕으로 한 초안이라 틀릴 수 있어요. 확인하고 고치거나 비워 둘 수 있어요.', memoField: '기록 글', memoHint: 'AI 문구는 글 끝에 추가돼요. 자유롭게 고치거나 지울 수 있어요.', sceneField: '장면, 선택 사항', sceneCount: '{count} / 120자', sceneHint: '비우면 장면을 삭제해요.', tagsSection: '태그', semanticTags: '의미 태그', semanticHint: '최대 8개, 태그당 24자', moodTags: '분위기 태그', moodHint: '최대 3개, 태그당 24자', analysisOptional: '글과 태그는 비워도 저장할 수 있어요.', suggest: 'AI 문구 추가', suggesting: 'AI 문구 만드는 중…', suggestRetry: 'AI 문구 추가 다시 시도', suggestFailed: 'AI 문구를 추가하지 못했어요. 입력한 글은 그대로예요. 잠시 후 다시 시도해 주세요.', invalid: '입력한 내용을 확인해 주세요.', paletteBody: '사진에서 추출한 색과 비중이에요.\n대표색은 직접 바꾸지 않아요.', paletteHint: '그날의 분위기를 색으로 기억해요.', viewer: '원본 사진',
  },
  en: {
    back: 'Back', close: 'Close', cancel: 'Cancel edit', apply: 'Apply to draft', applyEdit: 'Apply changes',
