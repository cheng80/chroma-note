...
function AppContent() {
  ...
  const { state, send, images, assets, visibleRecords, draft, record, hasMore, refreshing, pullRefreshing, resendSeconds, pendingDeletions, canSaveBeforeLogout, sessionRestoreStatus, retrySessionRestore, beginSessionReauthentication } = useAppController();
